  ...
  return (
    <div className="rounded-panneau border border-bordure bg-surface p-bloc">
      <div className="flex items-center gap-encart">
        ...
        <kbd className="rounded-champ border border-bordure bg-surface-creuse px-2 py-1 text-xs text-encre-faible">
          espace
        </kbd>

        {source ? (
          // La clé force le rechargement quand l'audio change.
          <audio key={source} controls src={source} className="h-9 flex-1" />
        ) : (
